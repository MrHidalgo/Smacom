...
<head>
    ...
    <!--    <script type="text/javascript" src="inc/jquery.socialfeed.utility.js"></script>-->
    <!--    <script type="text/javascript"src="inc/jquery.socialfeed.js"></script>-->
    ...
    <!--<script type="text/javascript"src="inc/jquery-threesixty.0.6.js"></script>-->
...
<!--	<div class="imageStack" >
		...
		<img src="img/preloader/3.png" alt="" />
		<img src="img/preloader/1.png" alt="" />
		<img src="img/preloader/9.png" alt="" />
		<img src="img/preloader/5.png" alt="" />
		<img src="img/preloader/2.png" alt="" />
		<img src="img/preloader/7.png" alt="" />
		<img src="img/preloader/6.png" alt="" />
		<img src="img/preloader/8.png" alt="" />
		<img src="img/preloader/4.png" alt="" />
		<img src="img/banners_inner/banner4.jpg" alt="" />
		<img src="img/banners_inner/banner3.jpg" alt="" />
		<img src="img/banners_inner/banner6.jpg" alt="" />
		<img src="img/banners_inner/banner1.jpg" alt="" />
		<img src="img/banners_inner/banner2.jpg" alt="" />
		<img src="img/subnav_current.png" alt="" />
		<img src="img/back.png" alt="" />
		<img src="img/back_hover.png" alt="" />
		<img src="img/social/f_mover.png" alt="" />
		<img src="img/social/t_mover.png" alt="" />
		<img src="img/social/v_mover.png" alt="" />
		<img src="img/brand_thumb_hover_1.jpg" alt="">
		<img src="img/brand_thumb_hover_2.jpg" alt="">
		<img src="img/brand_thumb_hover_3.jpg" alt="">
...
<div class="navSmall">
    <ul id="navSmall">
        ...
        <li><a href="#block1">Продукция</a></li>
        ...
        <li><a href="#block3">Партнерам</a></li>
...
<!--	<div class="header subnavHeader">
			<a href="#" onClick="window.location.href='/'">вернуться на главную</a>
			<div class="menuSwitcherWrapper"><div class="menuSwitcher"></div></div>
	</div>

    <a href="#" onClick="window.location.href='/'" class="back"></a>-->

<div class="header subnavHeader">
    <a href="#" onClick="pageHistory.back('home'); return false;">вернуться на главную</a>
    <div class="menuSwitcherWrapper">
        <div class="menuSwitcher"></div>
    </div>
</div>
<a onClick="pageHistory.back('home'); return false;" class="back"></a>
        ...
        <div class="es-carousel">
            <ul>
                <li><a href="#" id="cat_link_1" onclick="renderInnerPage(this, 'cat',1);"><img alt=""
                            ...
                            class="title">Котлеты и блюда из мясного фарша</span></a></li>
        ...
        <div class="es-carousel">
            <ul>
                ...
                <li><a href="#" id="cat_link_8" onclick="renderInnerPage(this, 'cat',8);"><img alt=""
                            ...
                            class="title">Фирменные</span></a></li>
...
<div class="subnav header-subnav closed" id="subnav4">
    <div class="">
        ...
        <div class="navigat">
            <ul id="navigat">
                <li>
                    <a href="" onClick="pageHistory.back('home'); return false;">О компании</a>
                </li>
                <li>
                    <a href="" onClick="pageHistory.back('home'); return false;">Продукция</a>
                </li>
                <li>
                    <div onclick="renderInnerPage(this, 'cat', 15);">
                        <a href="#"> Продукция для HoReCa</a>
                    </div>
                </li>
                <li>
                    <a href="" onClick="return false;"> Экспорт</a>
                </li>
                <li>
                    <a href="" onClick="pageHistory.back('home'); return false;">Партнерам</a>
                </li>
                <li>
                    <a href="" onClick="pageHistory.back('home'); return false;">Контакты</a>
                </li>
            </ul>
        </div>
        <div class="menuSwitcherWrapper">
...
<div class="header" id="header">
    <div class="">
        ...
        <div class="nav">
            <ul id="nav">
                <li rel='block2'><a href="#block2">О компании</a></li>
                <li rel='block1'><a href="#block1">Продукция</a></li>
                <li>
                    <div onclick="renderInnerPage(this, 'cat', 15);">
                        <a href="" onClick="return false;">Продукция для HoReCa</a>
                    </div>
                </li>
                <li>
                ...
                <li rel='block3'><a href="#block3">Партнерам</a></li>
                <li rel='block4'><a href="#block4">Контакты</a></li>
            </ul>
            <ul class="lang">
                <li class="current"><a href="#">Рус</a></li>
                <li><a href="ua.php">Укр</a></li>
...
<div class="wrapper home">
    <div class="">
        ...
        <div class="cat" id="block1">
            ...
            <div class="filters">
                <a href="#subcat1" class="filter active">наша продукция</a><a href="#subcat2" class="filter">наши
                    торговые марки</a>
            </div>
            <div class="subcats" id="subcat1">
                <div class="animationGroup">
                    <div class="subcat">
                        ...
                        <div onclick="renderInnerPage(this, 'cat',1); " class="hoverBox frozen-cat">
                    ...
                    <div class="subcat">
                        ...
                        <div onclick="renderInnerPage(this, 'cat',2);" class="hoverBox">
                    ...
                    <div class="subcat">
                        ...
                        <div onclick="renderInnerPage(this, 'cat',3);" class="hoverBox">
                            <a href="" class="more" onClick="return false;">пельмени</a>
                        </div>
                    </div>


                    <!--<div class="subcat" onclick="renderInnerPage(this, 'cat',4);" >
                        <img src="img/product_thumb_5.png" alt="">
                        <a href="" class="more" onClick="return false;">мороженое</a>
                    </div>-->
                    <div class="subcat">
                        <img src="img/product_thumb_3.png" alt="">
                        <div onclick="renderInnerPage(this, 'cat',5);" class="hoverBox">
                            <a href="" class="more" onClick="return false;">блинчики</a>
                        </div>
                    </div>
                    <div class="subcat">
                        <img src="img/product_thumb_6.png" alt="">
                        <div onclick="renderInnerPage(this, 'cat',6);" class="hoverBox">
                            <a href="" class="more" onClick="return false;">выпечка</a>
                        </div>
                    </div>
                    <div class="subcat">
                        <img src="img/product_thumb_7.png" alt="">
                        <div onclick="renderInnerPage(this, 'cat',0);" class="hoverBox">
                            <a href="" class="more" onclick="return false;">готовые блюда</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--			<div id="block5" style="height: 40em;">
                    <p>al;dka;lsdj</p>
                </div>-->
    ...
    <div class="footer">
        <div class="middle">
            <!--<div class="socialLinks">
                <a href="#" id="facebook" target="_blank" class="link"></a>
                <a href="#" id="youtube" target="_blank" class="link"></a>
            </div>-->
